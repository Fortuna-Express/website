  ...
  <div class="container">
    <div class="red-border">
      ...
      <div class="flex justify-between mt-4 gap-2">
        <a href="https://cloud.securitasfleet.com/visitor/bf71a8a1-7196-4d64-bbad-83fc2bac76d2/assets" target="_blank" class="inline-block bg-red-700 hover:bg-red-500 text-white py-1 px-3 rounded-md text-sm shadow-md transition-colors duration-300">B7A-714</a>
        <a href="https://cloud.securitasfleet.com/visitor/317bdd31-6e48-4d71-b5f9-d273767ffffb/assets" target="_blank" class="inline-block bg-red-700 hover:bg-red-500 text-white py-1 px-3 rounded-md text-sm shadow-md transition-colors duration-300">C3W-837</a>
      </div>
    </div>
    <router-link to="/liquidations" >
